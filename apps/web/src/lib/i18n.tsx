...
const en = {
  ...
  'home.surface.suggestions.detail':
    'Review repeated agent friction as allowlisted knowledge-file cards.',
  ...
  'suggestions.empty': 'No promoted suggestions. A card appears only after the same failure shows up in at least two sessions.',
