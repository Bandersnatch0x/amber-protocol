...
const en = {
  ...
  'knowledge.searchPlaceholder':
    'Search titles, ids, status, content, code paths, exported symbols...',
  ...
  'knowledge.legend.implementation': 'implementation layer (features / code)',
  ...
  'knowledge.kind.code': 'Code',
  'knowledge.kind.foundation': 'Shared foundation',
  'knowledge.fold.expand': 'Expand implementation',
  'knowledge.fold.collapse': 'Collapse implementation',
  'knowledge.fold.collapseAll': 'Collapse all code',
  'knowledge.fold.aggregate': 'aggregate shared foundation',
  'knowledge.fold.foldedSuffix': '· {folded} code nodes folded',
  'knowledge.fold.anchorsChip': '{count} anchored files — click to expand or collapse',
  'knowledge.fold.searchHits': '{count} folded code matches',
  'knowledge.fold.searchHitAction': 'expand {feature}',
  'knowledge.fold.searchHitUnowned': 'select (no owning feature)',
  'knowledge.symbols': 'exported symbols',
  'knowledge.community': 'community',
  'knowledge.degree': 'degree',
  'knowledge.godNode.badge': 'hub',
  'knowledge.godNode.tooltip': 'At or above the p99 degree within its layer',
  'knowledge.foundation.members': '{count} aggregated members',
  'knowledge.foundation.description':
    'High fan-in code (in-degree above the code p99) aggregated in the renderer only — the graph data carries zero derived nodes.',
  'knowledge.feature.codeSummary': 'anchored code sits in {communities} · {hubs} high fan-in',
  'knowledge.rail.analytics': 'Analytics',
  'knowledge.analytics.title': 'Deterministic analytics report',
  'knowledge.analytics.description':
    'Computed at read time over the deterministic graph — never persisted, never part of graph bytes.',
  'knowledge.analytics.metrics':
    '{nodes} nodes · {edges} edges · {communities} communities · largest community {largest}% · singleton weight {singleton}%',
  'knowledge.analytics.godNodes': 'God nodes (p99 per layer)',
  'knowledge.analytics.godNodeRow': '{degree}° · {inDegree} in / {outDegree} out',
  'knowledge.analytics.communities': 'Communities',
  'knowledge.analytics.communityRow': '{id} · {size} nodes · e.g. {sample}',
  'knowledge.analytics.anomalies': 'Anomalous connections',
  'knowledge.analytics.anomaliesEmpty': 'No anomaly marks.',
  'knowledge.analytics.reason.rare-cross-kind-pair': 'rare cross-kind pair',
  'knowledge.analytics.reason.inter-community-bridge': 'inter-community bridge',
  'knowledge.analytics.neutral':
    'Marks are neutral "worth a look" signals from deterministic detectors — anomaly does not mean error.',
  'knowledge.recentDrift': 'Recent & Drift',
  'knowledge.recentLoading': 'Loading recent changes…',
  'knowledge.recentRefresh': 'Refresh',
  'knowledge.recentRefreshing': 'Refreshing…',
  'knowledge.recentEmpty': 'No recent changes or drift findings.',
  ...
  'knowledge.inferredTooltip': 'Inferred by {model} · prompt {hash} · {time}',
  ...
  'knowledge.semantic.unavailable':
    'LLM provider not configured — showing deterministic data only.',
  'knowledge.semantic.invalidConfig':
    'Semantic analysis is unavailable because the provider configuration is invalid.',
  'knowledge.semantic.disclosure':
    'Optional semantic analysis sends repository node identifiers, kinds, titles, excerpts, and existing edges to the configured {provider} provider. Nothing is persisted.',
  'knowledge.semantic.run': 'Send repository titles and excerpts for semantic analysis',
  'knowledge.semantic.runAgain': 'Run semantic analysis again',
  'knowledge.semantic.error':
    'Semantic analysis failed or was incomplete. The deterministic map remains available.',
  'knowledge.semantic.statusError':
    'Semantic provider status could not be loaded. The deterministic map remains available.',
  'knowledge.semantic.loading': 'Loading semantic layer…',
  'knowledge.semantic.badge': 'inferred',
  'knowledge.summary': 'summary',
  'knowledge.summary.provenance': 'inferred by {provider}/{model} · {timestamp}',
  'knowledge.rail.label': 'Knowledge panel',
  'knowledge.rail.detail': 'Detail',
  'knowledge.rail.ask': 'Ask',
  'knowledge.ask.title': 'Ask the knowledge map',
  'knowledge.ask.description': 'Answers use only the current deterministic graph snapshot.',
  'knowledge.ask.questionLabel': 'Question',
  'knowledge.ask.placeholder': 'What decision governs this area?',
  'knowledge.ask.disclosure':
  ...
  'knowledge.ask.invalidConfig': 'Ask is unavailable because the LLM configuration is invalid.',
  'knowledge.ask.error':
    'The answer could not be generated. The deterministic map remains available.',
  'knowledge.ask.overflow':
    'The deterministic context exceeds the supported bound and was not sent.',
  'knowledge.ask.uncitable': 'No answer with valid citations could be produced.',
  'knowledge.ask.invalidFocus': 'The selected focus node is no longer in the current snapshot.',
  'knowledge.ask.result': 'Answer',
  'knowledge.ask.submittedQuestion': 'Submitted question: {question}',
  'knowledge.ask.submittedFocus': 'Submitted focus: {id} and its two-hop neighborhood.',
  'knowledge.ask.submittedNoFocus':
    'Submitted without a focus; the bounded full snapshot was used.',
  'knowledge.ask.citations': 'Citations',
  'knowledge.ask.omitted': '{count} uncited claims omitted',
  'knowledge.ask.superseded': 'superseded',
  'knowledge.ask.supersededBy': 'current: {id}',
  ...
  'home.viewerBoundary':
    'The Viewer reflects repository-local Amber state. Agent and CLI surfaces remain authoritative for governed work.',
  'home.openSessions': 'Open Sessions',
  'home.reviewGates': 'Review Gates',
  'home.repository': 'Repository',
  'home.repositoryName': 'Current repository',
  ...
  'home.recentSessions': 'Recent session outcomes',
  'home.recentSessionsDetail':
    'Completed and interrupted sessions stay visible so recovery and acceptance remain distinguishable.',
  'home.pendingGates': 'Pending Gates',
  'home.primaryWorkflows': 'Continue the Journey',
  'home.primaryWorkflowsDetail':
    'Sessions carry delivery and recovery; Gates carry review decisions.',
  'home.secondarySurfaces': 'Evidence & Conditional Paths',
  'home.secondarySurfacesDetail':
    'Open these when a core journey exposes a context, evidence, or repeated-friction need.',
  'home.journey.title': 'Core Journey',
  'home.journey.detail':
    'One path from fit to acceptance. Routes specialize the work behind the scenes without creating a second user journey.',
  'home.journey.current': 'Current',
  'home.journey.unavailable': 'Unavailable',
  'home.journey.j0.title': 'Establish fit',
  'home.journey.j0.detail': 'Confirm a real continuity or review problem.',
  'home.journey.j1.title': 'Adopt safely',
  'home.journey.j1.detail': 'Install the minimum surface without overwrites.',
  'home.journey.j2.title': 'Prove continuation',
  'home.journey.j2.detail': 'Let a fresh context take one correct next step.',
  'home.journey.j3.title': 'Deliver',
  'home.journey.j3.detail': 'Frame, authorize, work, and preserve evidence.',
  'home.journey.j4.title': 'Recover',
  'home.journey.j4.detail': 'Resume at the stage where work actually stopped.',
  'home.journey.j5.title': 'Review & accept',
  'home.journey.j5.detail': 'Make a go/no-go decision from repository evidence.',
  ...
  'home.nextAction.title': 'Continue Safely from Here',
  ...
  'home.nextAction.reason': 'Why now',
  'home.nextAction.remedy': 'Command or recovery',
  ...
  'home.surface.sessions.detail':
    'Continue active delivery, inspect checkpoints, or recover work at the correct stage.',
  'home.surface.gates.detail':
    'Make a go/no-go decision from the plan, current state, and recorded evidence.',
  'home.surface.suggestions.detail':
    'Conditional J7 surface: review friction only after it repeats across sessions.',
  ...
  'sessions.drift.exact': 'Replay EXACT',
  'sessions.drift.compatible': 'Replay COMPATIBLE',
  'sessions.drift.drifted': 'Replay DRIFTED',
  'sessions.drift.nonReplayable': 'Replay unavailable',
  ...
  'suggestions.title': 'Improvement Suggestions',
  'suggestions.description':
    'Repeated tool failures across Claude, Codex, and Cursor sessions, clustered into reviewable knowledge-file cards. Apply never writes product code or tests.',
  'suggestions.count': '{count} suggestions',
  'suggestions.countOne': '1 suggestion',
  'suggestions.empty':
    'No promoted suggestions. A card appears only after the same failure shows up in at least two sessions.',
  'suggestions.failed': 'Could not load suggestions',
  'suggestions.failedDetail': 'The viewer could not cluster host transcripts for this repository.',
  'suggestions.filter.open': 'Open',
  'suggestions.filter.resolved': 'Resolved',
  'suggestions.evidenceBadge': 'came up {count} times across {hosts}',
  'suggestions.evidenceBadgeOne': 'came up once across {hosts}',
  'suggestions.preview': 'Preview',
  'suggestions.hidePreview': 'Hide preview',
  'suggestions.seeEvidence': 'See evidence',
  'suggestions.hideEvidence': 'Hide evidence',
  'suggestions.apply': 'Apply',
  'suggestions.dismiss': 'Dismiss',
  'suggestions.snooze': 'Snooze 7 days',
  'suggestions.undo': 'Undo',
  'suggestions.applyOk': 'Applied to the allowlisted knowledge file.',
  'suggestions.undoOk': 'Restored the previous knowledge-file bytes.',
  'suggestions.mutationFailed': '{message}',
  'suggestions.operation.create': 'create',
  'suggestions.operation.update': 'update',
  'suggestions.operation.remove': 'remove',
  'suggestions.artifact.wiki': 'wiki',
  'suggestions.artifact.agents-md': 'AGENTS.md',
  'suggestions.artifact.skill': 'skill',
  'suggestions.status.open': 'open',
  'suggestions.status.snoozed': 'snoozed',
  'suggestions.status.dismissed': 'dismissed',
  'suggestions.status.applied': 'applied',
  'suggestions.status.stale': 'stale',
  'suggestions.hostsScanned': '{host}: {count} transcripts',
} as const;
...
const zh: Record<TranslationKey, string> = {
  ...
  'knowledge.searchPlaceholder': '按标题、ID、状态、内容、代码路径、导出符号搜索…',
  ...
  'knowledge.legend.implementation': '实现层（特性 / 代码）',
  ...
  'knowledge.kind.code': '代码',
  'knowledge.kind.foundation': '共享基座',
  'knowledge.fold.expand': '展开实现',
  'knowledge.fold.collapse': '收起实现',
  'knowledge.fold.collapseAll': '收起全部代码',
  'knowledge.fold.aggregate': '聚合共享基座',
  'knowledge.fold.foldedSuffix': '· {folded} 个代码节点已折叠',
  'knowledge.fold.anchorsChip': '{count} 个锚定文件 — 点击展开或收起',
  'knowledge.fold.searchHits': '{count} 个折叠代码命中',
  'knowledge.fold.searchHitAction': '展开 {feature}',
  'knowledge.fold.searchHitUnowned': '选中（无所属特性）',
  'knowledge.symbols': '导出符号',
  'knowledge.community': '社区',
  'knowledge.degree': '度数',
  'knowledge.godNode.badge': '枢纽',
  'knowledge.godNode.tooltip': '达到或超过本层 p99 度数',
  'knowledge.foundation.members': '{count} 个聚合成员',
  'knowledge.foundation.description':
    '高扇入代码（入度超过代码层 p99）仅在渲染层聚合 — 图数据不含任何派生节点。',
  'knowledge.feature.codeSummary': '锚定代码位于 {communities} · {hubs} 个高扇入模块',
  'knowledge.rail.analytics': '分析',
  'knowledge.analytics.title': '确定性分析报告',
  'knowledge.analytics.description': '读取时基于确定性关系图计算 — 不持久化，也不进入图字节。',
  'knowledge.analytics.metrics':
    '{nodes} 节点 · {edges} 边 · {communities} 社区 · 最大社区 {largest}% · 单点权重 {singleton}%',
  'knowledge.analytics.godNodes': 'God 节点（每层 p99）',
  'knowledge.analytics.godNodeRow': '{degree}° · 入 {inDegree} / 出 {outDegree}',
  'knowledge.analytics.communities': '社区',
  'knowledge.analytics.communityRow': '{id} · {size} 节点 · 例如 {sample}',
  'knowledge.analytics.anomalies': '异常连接',
  'knowledge.analytics.anomaliesEmpty': '暂无异常标记。',
  'knowledge.analytics.reason.rare-cross-kind-pair': '罕见跨类型对',
  'knowledge.analytics.reason.inter-community-bridge': '跨社区桥',
  'knowledge.analytics.neutral':
    '标记来自确定性检测器，只是中性的「值得一看」信号 — 异常不等于错误。',
  'knowledge.recentDrift': '最近变更与漂移',
  'knowledge.recentLoading': '正在加载最近变更…',
  'knowledge.recentRefresh': '刷新',
  'knowledge.recentRefreshing': '正在刷新…',
  'knowledge.recentEmpty': '暂无最近变更或漂移发现。',
  ...
  'knowledge.inferredTooltip': '由 {model} 推断 · 提示词 {hash} · {time}',
  ...
  'knowledge.semantic.unavailable': '未配置 LLM 提供者 — 仅显示确定性数据。',
  'knowledge.semantic.invalidConfig': '提供者配置无效，因此语义分析不可用。',
  'knowledge.semantic.disclosure':
    '可选语义分析会将仓库节点标识、类型、标题、摘要片段和现有关联发送给已配置的 {provider} 提供者。结果不会持久化。',
  'knowledge.semantic.run': '发送仓库标题和摘要片段进行语义分析',
  'knowledge.semantic.runAgain': '再次运行语义分析',
  'knowledge.semantic.error': '语义分析失败或不完整。确定性关系图仍然可用。',
  'knowledge.semantic.statusError': '无法加载语义提供者状态。确定性关系图仍然可用。',
  'knowledge.semantic.loading': '正在加载语义层…',
  'knowledge.semantic.badge': '推断',
  'knowledge.summary': '摘要',
  'knowledge.summary.provenance': '由 {provider}/{model} 推断 · {timestamp}',
  'knowledge.rail.label': '知识面板',
  'knowledge.rail.detail': '详情',
  'knowledge.rail.ask': '提问',
  'knowledge.ask.title': '向知识地图提问',
  'knowledge.ask.description': '回答仅使用当前确定性关系图快照。',
  'knowledge.ask.questionLabel': '问题',
  'knowledge.ask.placeholder': '哪个决策管理这个领域？',
  'knowledge.ask.disclosure':
  ...
  'knowledge.ask.invalidConfig': 'LLM 配置无效，提问功能不可用。',
  'knowledge.ask.error': '无法生成回答。确定性关系图仍然可用。',
  'knowledge.ask.overflow': '确定性上下文超出支持范围，因此未发送。',
  'knowledge.ask.uncitable': '无法生成带有有效引用的回答。',
  'knowledge.ask.invalidFocus': '所选焦点节点已不在当前快照中。',
  'knowledge.ask.result': '回答',
  'knowledge.ask.submittedQuestion': '已提交的问题：{question}',
  'knowledge.ask.submittedFocus': '提交时聚焦于 {id} 及其两跳邻域。',
  'knowledge.ask.submittedNoFocus': '提交时未选择焦点；使用了有界的完整快照。',
  'knowledge.ask.citations': '引用',
  'knowledge.ask.omitted': '已省略 {count} 条无引用陈述',
  'knowledge.ask.superseded': '已被取代',
  'knowledge.ask.supersededBy': '当前：{id}',
  'theme.toggle': '\u5207\u6362\u4e3b\u9898',
  ...
  'home.viewerBoundary':
    'Viewer 只反映仓库本地 Amber 状态；Agent 与 CLI 仍是受治理工作的权威入口。',
  'home.openSessions': '\u6253\u5f00\u4f1a\u8bdd',
  'home.reviewGates': '\u5ba1\u9605\u5173\u5361',
  'home.repository': '\u4ed3\u5e93',
  'home.repositoryName': '\u5f53\u524d\u4ed3\u5e93',
  'home.repositoryDetail':
    '\u4ed3\u5e93\u672c\u5730\u67e5\u770b\u5668\uff0c\u4e0d\u4f9d\u8d56\u5916\u90e8\u9065\u6d4b\u6216\u6258\u7ba1\u670d\u52a1\u3002',
  'home.lastRefresh': '\u4e0a\u6b21\u5237\u65b0',
  'home.notRefreshed': '\u5c1a\u672a\u5237\u65b0',
  'home.activeSessions': '\u6d3b\u8dc3\u4f1a\u8bdd',
  'home.noActiveSessions': '\u5f53\u524d\u6ca1\u6709\u6d3b\u8dc3\u4f1a\u8bdd',
  'home.recentSessions': '\u6700\u8fd1\u4f1a\u8bdd\u7ed3\u679c',
  'home.recentSessionsDetail':
    '\u5df2\u5b8c\u6210\u548c\u4e2d\u65ad\u7684\u4f1a\u8bdd\u4ecd\u4f1a\u4fdd\u7559\uff0c\u4ee5\u533a\u5206\u6062\u590d\u4e0e\u9a8c\u6536\u3002',
  'home.pendingGates': '\u5f85\u5904\u7406\u5173\u5361',
  'home.primaryWorkflows': '继续当前旅程',
  'home.primaryWorkflowsDetail': 'Session 承载交付与恢复，Gate 承载审查决定。',
  'home.secondarySurfaces': '证据与条件路径',
  'home.secondarySurfacesDetail': '只有核心旅程暴露上下文、证据或重复摩擦问题时才进入这些表面。',
  'home.journey.title': '核心用户旅程',
  'home.journey.detail':
    '从资格判断到审查验收只保留一条前台路径；Route 在后台分型，不建立第二套用户旅程。',
  'home.journey.current': '当前',
  'home.journey.unavailable': '不可用',
  'home.journey.j0.title': '判断适配',
  'home.journey.j0.detail': '确认存在真实的续接或审查问题。',
  'home.journey.j1.title': '安全接入',
  'home.journey.j1.detail': '不覆盖已有文件地安装最小表面。',
  'home.journey.j2.title': '证明续接',
  'home.journey.j2.detail': '让新上下文正确继续一步。',
  'home.journey.j3.title': '日常交付',
  'home.journey.j3.detail': '定义、授权、工作并保留证据。',
  'home.journey.j4.title': '失败恢复',
  'home.journey.j4.detail': '回到工作实际停止的阶段。',
  'home.journey.j5.title': '审查验收',
  'home.journey.j5.detail': '依据仓库证据作出 go/no-go 决定。',
  ...
  'home.nextAction.reason': '为什么是现在',
  'home.nextAction.remedy': '命令或恢复动作',
  'home.nextAction.nextStep': '\u4e0b\u4e00\u6b65',
  'home.nextAction.openSession': '\u6253\u5f00\u4f1a\u8bdd',
  'home.nextAction.repositoryFocus': '\u4ed3\u5e93',
  'home.surface.sessions.detail': '继续活跃交付、检查 checkpoint，或在正确阶段恢复工作。',
  'home.surface.gates.detail': '依据计划、当前状态与已记录证据作出 go/no-go 决定。',
  'home.surface.suggestions.detail': 'J7 条件入口：只有同类摩擦跨会话重复后才进入审查。',
  ...
  'sessions.drift.exact': '\u91cd\u653e\u4e00\u81f4 EXACT',
  'sessions.drift.compatible': '\u91cd\u653e\u517c\u5bb9 COMPATIBLE',
  'sessions.drift.drifted': '\u91cd\u653e\u6f02\u79fb DRIFTED',
  'sessions.drift.nonReplayable': '\u6682\u4e0d\u53ef\u91cd\u653e',
  'sessions.unknown': '\u672a\u77e5',
  'sessions.tokens': '{used} / {max} tokens',
  ...
  'suggestions.description':
    '把 Claude、Codex、Cursor 会话里重复出现的工具失败收成可审的知识文件卡片。应用操作不会改产品代码或测试。',
  'suggestions.count': '{count} 条建议',
  'suggestions.countOne': '1 条建议',
  'suggestions.empty': '还没有晋升的建议。同一失败至少出现在两次会话里才会生成卡片。',
  'suggestions.failed': '无法加载建议',
  'suggestions.failedDetail': '查看器无法为当前仓库聚类各编码代理的会话记录。',
  'suggestions.filter.open': '待处理',
  'suggestions.filter.resolved': '已处理',
  'suggestions.evidenceBadge': '在 {hosts} 中出现 {count} 次',
  'suggestions.evidenceBadgeOne': '在 {hosts} 中出现 1 次',
  'suggestions.preview': '预览',
  'suggestions.hidePreview': '收起预览',
  'suggestions.seeEvidence': '查看证据',
  'suggestions.hideEvidence': '收起证据',
  'suggestions.apply': '应用',
  'suggestions.dismiss': '忽略',
  'suggestions.snooze': '推迟 7 天',
  'suggestions.undo': '撤销',
  'suggestions.applyOk': '已写入允许的知识文件。',
  'suggestions.undoOk': '已恢复知识文件的先前内容。',
  'suggestions.mutationFailed': '{message}',
  'suggestions.operation.create': '新建',
  'suggestions.operation.update': '更新',
  'suggestions.operation.remove': '删除',
  'suggestions.artifact.wiki': 'wiki',
  'suggestions.artifact.agents-md': 'AGENTS.md',
  'suggestions.artifact.skill': 'skill',
  'suggestions.status.open': '待处理',
  'suggestions.status.snoozed': '已推迟',
  'suggestions.status.dismissed': '已忽略',
  'suggestions.status.applied': '已应用',
  'suggestions.status.stale': '已过期',
  'suggestions.hostsScanned': '{host}：{count} 份记录',
};
