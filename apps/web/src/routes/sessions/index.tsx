      ...
      <header className="space-y-2">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-400">
          {Array.isArray(sessions)
            ? t(filteredSessions.length === 1 ? 'sessions.countOne' : 'sessions.count', {
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  ...
                  >
                    ...
                    <h2 className="truncate text-sm font-medium text-slate-900 dark:text-white sm:text-base">
                      {session.goal}
                    </h2>
                    <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-slate-500 dark:text-slate-400">
                      <span>
                        {t('sessions.lastActivity', {
                          time: formatLatestActivity(latestActivity, t('sessions.unknown')),
                        })}
                      </span>
