...
} from '@/features/routes/route-detail-view-model';
                    ...
                    <div className="min-w-0 flex-1 space-y-2">
                      <div>
                        ...
                        <p className="mt-1 break-all font-mono text-xs text-slate-500 dark:text-slate-400">
                          {buildStageDetailLine(stage)}
                        </p>
                      </div>
                      {stage.gateAfter && (
                        <p className="text-xs text-slate-600 dark:text-slate-400">
                          {t('routes.detail.gateAfter', { gate: stage.gateAfter })}
                        </p>
                      )}
          ...
          <dl className="mt-4 space-y-4">
            {metadata.map((item) => (
              <div key={item.labelKey}>
                ...
                <dd className="mt-1 break-all text-sm text-slate-900 dark:text-white">
                  {item.value}
                </dd>
              </div>
            ))}
