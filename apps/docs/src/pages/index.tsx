      ...
      <main>
        <section className={styles.section}>
          <div className={styles.sectionHeader}>
            ...
            <h2 className={styles.sectionTitle}>Built for Trust, Auditability, and Control</h2>
        ...
        <section className={styles.workflowSection}>
          <div className={styles.workflowContainer}>
            <div className={styles.sectionHeader}>
              ...
              <h2 className={styles.sectionTitle}>The 5-Stage Governed Engineering Loop</h2>
              <p className={styles.sectionSubtitle}>
            ...
            <div className={styles.timelineGrid}>
              {LIFECYCLE_STEPS.map((item, idx) => (
                <div key={idx} className={styles.timelineItem}>
                  ...
                  <div className={styles.timelineCode}>{item.cmd}</div>
