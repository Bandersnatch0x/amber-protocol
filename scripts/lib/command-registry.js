...
const COMMAND_HELP = {
	...
	runner: [
		...
		"environment (runner-request:<environment>:<requestHash>).",
		"",
		"Subcommands:",
		...
		"        --credential <none|scoped> --rollback <declaration>",
...
const COMMAND_OUTPUT = {
	...
	runner: {
		usage: [
			"Usage: amber runner <register|capability|request|authorize|requests|show|list> --target <repo> [--json]",
			...
			"       amber runner request --target <repo> --id <runner-id> --runner-version <version> --capability <name> --capability-version <version> --repository <repo-id> --path <path> --environment development|staging|production --timeout-ms <n> --effect <effect> --credential none|scoped --rollback <declaration> [--scope <scope>] [--input-hash <sha256:...>] [--json]",
