...
const COMMAND_HELP = {
	...
	external: [
		...
		"authorize them drift-bound, and settle governed executions",
		"(F056 T1-T3).",
		...
		"one execution with its settlement and reconciliation. Nothing",
		"under this command executes an external operation.",
		"",
		"Subcommands:",
...
const COMMAND_OUTPUT = {
	...
	release: {
		usage: [
			"Usage: amber release <prepare|authorize|deploy|rollback|transactions|status|receipts|show|list> --target <repo> [--json]",
	...
	retention: {
		usage: [
			"Usage: amber retention <classify|evaluate|classifications|hold|release|holds|holder|holders|candidate|authorize|candidates|execute|settle|status|proof> --target <repo> [--json]",
	...
	external: {
		usage: [
			"Usage: amber external <register|effects|propose|authorize|proposals|execute|settle|reconcile|status> --target <repo> [--json]",
