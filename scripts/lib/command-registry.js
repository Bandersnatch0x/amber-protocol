...
const COMMAND_HELP = {
	...
	external: [
		...
		"operation, no MCP capability resolves to it, and the ADR-0020 sync",
	...
	breakglass: [
		...
		"skipped. No MCP capability resolves to this command, the ADR-0020",
		"transport exception stays isolated, and break-glass waives",
		"nothing.",
		"",
		"Subcommands:",
		...
		"",
		"Examples:",
		"  amber breakglass grant --target . --id breakglass/incident-42-restore --incident incident/42 --purpose restore-login-service --capability external:effect/ticket-comment@1 --exact-target tracker/amber-protocol --scope issues --environment production --risk high --credential scoped --valid-from 2026-08-29T00:00:00.000Z --valid-until 2026-08-29T01:00:00.000Z --review-by 2026-09-01T00:00:00.000Z --decision-identity decision/breakglass-42 --revision 1 --json",
