...
const COMMAND_HELP = {
	...
	retention: [
		...
		"deterministically, govern Legal Holds, register Holders, and review",
		"deletion candidates with bounded authorization (F055 T1-T3).",
		...
		"content; any drift refuses. Execution and settlement are F055 T4.",
		"",
		"Subcommands:",
...
const COMMAND_OUTPUT = {
	...
	retention: {
		usage: [
			"Usage: amber retention <classify|evaluate|classifications|hold|release|holds|holder|holders|candidate|authorize|candidates> --target <repo> [--json]",
