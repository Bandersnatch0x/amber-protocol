...
const COMMAND_HELP = {
	...
	artifact: [
		...
		"decision, gate, policy. intent, spec, and plan each have a closed lifecycle of",
		...
		"evaluate` is that content's strict-consumption consumer.",
		"",
	...
	policy: [
		...
		"separation of duties cannot be relaxed, and unsupported allow/relax keys fail closed.",
		"",
		"Subcommands:",
