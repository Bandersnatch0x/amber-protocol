...
const COMMAND_OUTPUT = {
	...
	harness: {
		usage: [
			...
			"       amber harness execution cancel --run <id> --decision <identity>@<revision> --reason <text> --target <repo> [--json]",
			"       amber harness execution handles [--run <id>] --target <repo> [--json]",
	...
	breakglass: {
		usage: [
			"Usage: amber breakglass <grant|revoke|grants|use|show|settle|review|status> --target <repo> [--json]",
...
// platform/expert tier — fully callable, visible under `amber --all`.
// DEFAULT_COMMANDS derives from this map by filtering the COMMANDS array.
// The public array carries the canonical order, so the CLI and tier projection
// cannot drift through a second display-order constant.
