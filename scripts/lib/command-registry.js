...
const COMMAND_HELP = {
	...
	eval: [
		...
		"breadcrumb authenticity. `eval run` is report-only; `eval admit` is the",
		"explicit F050 admission path that writes canonical Eval definition/result",
		"artifacts and a replayable Evidence receipt. Eval is not Approval and",
		"cannot widen execution authority.",
		"",
		"Subcommands:",
	...
	adapter: [
		...
		"with status fresh/stale/unavailable and exact source bytes/digest.",
		"",
		"Subcommands:",
		...
		"  read --id <id> --source <path> --record-id <id> [--record-type <type>] [--record-version <v>] [--scope <scope>]",
		"  show --id <id>",
		"  list",
...
const COMMAND_OUTPUT = {
	...
	adapter: {
		usage: [
			...
			"       amber adapter read --target <repo> --id <id> --source <path> --record-id <id> [--record-type <type>] [--record-version <version>] [--scope <scope>] [--json]",
