...
const COMMAND_HELP = {
	...
	sync: [
		...
		"        proposed git operations as strings — Amber NEVER runs",
		"        git add, git commit, or git push, and there is no --execute",
		"        escape hatch. Live transport needs its own accepted ADR.",
