...
const COMMAND_HELP = {
	...
	maintain: [
		...
		"Trigger Proposals, and triage them (F054 T1-T3).",
		...
		"Decisions are single-use across the maintain ledgers. All ledgers are",
		"hash-chained and fail every read closed.",
		"",
		"Subcommands:",
...
const COMMAND_OUTPUT = {
	...
	maintain: {
		usage: [
			"Usage: amber maintain <register-detector|detect|propose|triage|detectors|findings|proposals> --target <repo> [--json]",
