...
const COMMAND_HELP = {
	...
	external: [
		"Register External Effect contracts, propose exact requests, and",
		"authorize them drift-bound (F056 T1-T2).",
		...
		"read-only. Nothing under this command executes an external",
		"operation.",
		"",
		"Subcommands:",
...
const COMMAND_OUTPUT = {
	...
	external: {
		usage: [
			"Usage: amber external <register|effects|propose|authorize|proposals> --target <repo> [--json]",
