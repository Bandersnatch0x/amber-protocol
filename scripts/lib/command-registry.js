...
const COMMAND_HELP = {
	...
	retention: [
		...
		"deterministically, and govern Legal Holds (F055 T1+T2).",
...
const COMMAND_OUTPUT = {
	...
	retention: {
		usage: [
			"Usage: amber retention <classify|evaluate|classifications|hold|release|holds> --target <repo> [--json]",
