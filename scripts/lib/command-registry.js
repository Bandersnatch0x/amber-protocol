...
const COMMAND_HELP = {
	...
	maintain: [
		"Register Control Band detectors, record deterministic Findings, and derive",
		"Trigger Proposals (F054 T1+T2).",
		...
		"All ledgers are hash-chained and fail every read closed.",
		"",
		"Subcommands:",
...
const COMMAND_OUTPUT = {
	...
	maintain: {
		usage: [
			"Usage: amber maintain <register-detector|detect|propose|detectors|findings|proposals> --target <repo> [--json]",
