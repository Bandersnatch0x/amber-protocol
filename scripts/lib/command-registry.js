...
const COMMAND_HELP = {
	...
	external: [
		"Register External Effect contracts and read the registry (F056 T1).",
		...
		"and fails closed on a corrupt ledger. Nothing under this command",
...
const COMMAND_OUTPUT = {
	...
	external: {
		usage: [
			"Usage: amber external <register|effects> --target <repo> [--json]",
