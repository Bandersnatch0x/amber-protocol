...
const COMMAND_HELP = {
	...
	breakglass: [
		"Grant, revoke, and list break-glass authorizations (F057 T1).",
		...
		"reason. Status derives read-time (granted|revoked|expired;",
		"revocation always wins) and history is never rewritten: revoked",
		"and expired grants stay listable forever with their original",
		"content intact. Every grant-facing name is a closed slug and",
		"credential-looking material refuses: the audit trail carries no",
		"secret. Nothing under this command executes anything.",
		"",
		"Subcommands:",
		...
		"        --decision-identity <identity> --revision <n> [--now <iso>]",
		"  grants [--status <granted|revoked|expired>] [--now <iso>]",
		"",
		"Examples:",
...
const COMMAND_OUTPUT = {
	...
	breakglass: {
		usage: [
			"Usage: amber breakglass <grant|revoke|grants> --target <repo> [--json]",
			...
			"       amber breakglass grants --target <repo> [--status granted|revoked|expired] [--now <iso>] [--json]",
		].join("\n"),
	},
};
