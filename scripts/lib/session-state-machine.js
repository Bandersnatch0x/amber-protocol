...
const TRANSITIONS = {
	[STATES.CREATED]: [STATES.ROUTED, STATES.FAILED, STATES.ABORTED],
	[STATES.ROUTED]: [STATES.EXECUTING, STATES.FAILED, STATES.ABORTED],
	[STATES.EXECUTING]: [
		STATES.PAUSED,
		STATES.COMPLETED,
		STATES.FAILED,
	...
	[STATES.PAUSED]: [STATES.EXECUTING, STATES.FAILED, STATES.ABORTED],
	[STATES.COMPLETED]: [],
	[STATES.FAILED]: [],
	[STATES.ABORTED]: [],
};
