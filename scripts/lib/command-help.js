...
const COMMAND_HELP = {
	...
	context: [
		"Close the context write path (ADR-0009): emit distillation contracts, judge agent",
		"output at the ingest gate, verify page health, refresh stale sources, and report",
		"cost/quality metrics. Amber never calls a model — an agent executes the contract.",
		"",
		"Subcommands:",
		...
		"        binding, source freshness. --request is optional (schema-only ingest).",
		...
		"  load --route <id> [--feature <id>] [--budget <n>] [--since <ts>]",
		"        Assemble a task-scoped loadout (ADR-0010): freshness-gated, budgeted,",
		"        provenance-linked selection of pages, written deterministically to",
		"        .amber/context/loadouts/<route>[-<feature>].json.",
		"  verify --loadout <file>",
		"        Re-check ONLY the loadout's required-tier pages (hash freshness) right",
		"        before the agent loads them.",
		"",
		"Examples:",
