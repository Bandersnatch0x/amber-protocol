...
const COMMAND_HELP = {
	...
	doctor: "Run Harness guardrail checks and target classification.",
	...
	review: "Review a plan against static Harness standards and release-readiness checks.",
	accept: [
		"Accept a reviewed plan and append a Harness evolution record.",
		"",
		"Options:",
		"  --plan <path>       Relative path to the plan to accept.",
		"  --session <id>      Optional session id; prints completion-gate status as a warning.",
		"  --strict             When used with --session, turn missing completion evidence into errors.",
		"",
		"Example:",
