...
// adoption-composer.js
// Consolidated rendering layer for all Adoption artifacts.
// Merged from:
//   - adoption-artifact-composer.js (588 lines)
//   - adoption-bundle-artifact.js (107 lines)
// This module is pure presentation logic — no business rules, no data fetching.
// Engine (adoption-engine.js) calls these functions to render markdown artifacts.
...
const { relativeSlash, pathExists, readJson, readText } = require("./fs-utils");
...
// ============================================================================
// Bundle Artifact Writer (from adoption-bundle-artifact.js)
// ============================================================================
