...
// --- Minimal YAML loader for plan files (supports common structures) ---
// This supports the knowledge plan format without introducing new runtime dependencies.
// It is intentionally tolerant and only parses the fields we care about.
...
function mergeInspectionIntoPlan(base, inspection, targetRoot) {
