...
function handleAdapter(args) {
	return adapterDispatch(args);
}

function handleRunner(args) {
	return runnerDispatch(args);
}

function handleRelease(args) {
	return releaseDispatch(args);
}

function handleMaintain(args) {
