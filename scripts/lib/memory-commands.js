...
// §5.4: approve output must surface the creed (admission/exclusion text) so the
// semantic standard is mechanically present at the decision point. Verbatim
// from templates/MEMORY.md — including the closing rule.
const CREED_HINT = [
