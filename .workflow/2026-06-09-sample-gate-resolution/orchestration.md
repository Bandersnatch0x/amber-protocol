# sample Gate Resolution Orchestration
...
3. `packet-c-verification`
   ...
   - Re-check sample boundary evidence.
   - Output implementer, spec review, and quality review records.
...
- Stop before any command that writes to `D:\code_space\trae-project\sample`.
- Stop before any command that runs sample tests, builds, lint, package scripts, or Python modules.
