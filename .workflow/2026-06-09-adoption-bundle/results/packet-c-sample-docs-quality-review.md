...
- Example bundle path follows the existing `sample-adoption-*` naming pattern.
- The generated bundle is self-contained and includes a machine-readable manifest.
- The sample boundary check covers the root Harness files most likely to reveal accidental initialization.
