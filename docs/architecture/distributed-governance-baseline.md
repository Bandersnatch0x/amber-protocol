...
The versioned contract inventory and compatibility matrix are maintained in [Distributed Governance Contract Registry](distributed-governance-contract-registry.md).
