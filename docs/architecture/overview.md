...
The versioned public-contract inventory and deterministic compatibility matrix are maintained in [Distributed Governance Contract Registry](distributed-governance-contract-registry.md).

The canonical fixture family and stable acceptance matrix are maintained in [Distributed Governance Fixture Family](distributed-governance-fixture-family.md).
