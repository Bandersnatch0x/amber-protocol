...
- `npm run lint` in apps/web reports zero react-hooks/set-state-in-effect and react-hooks/refs warnings (0 errors; 30 warnings remain — 29 react-refresh export-shape + 1 react-hooks/incompatible-library, both explicitly out of scope).
...
- Result: pass — tsc clean; lint 0 errors / 30 warnings (was 36: all 6 react-hooks set-state-in-effect/refs warnings cleared; remaining 29 react-refresh export-shape + 1 react-hooks/incompatible-library are out of scope); vitest 571/571; build clean; local Playwright E2E 43/43; root suite 2672/0
- Date: 2026-08-26
