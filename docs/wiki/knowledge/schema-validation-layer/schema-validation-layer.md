...
Document the JSON Schema contracts and runtime validation with ajv.

## Analysis Focus (from plan)
Cover schemas/*.schema.json, validators.js, schema-version-checker.js, and how ajv is used across the codebase.
