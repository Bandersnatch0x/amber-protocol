...
Document the auxiliary security scanners and state migration tools in src/.

## Analysis Focus (from plan)
Cover src/security/ (audit-report, dependency-scan, permission-review, secret-scan) and src/migration/ (dry-run, rollback, schema-validator, v5-to-phase-b).
