...
- [User scenarios](product/user-scenarios.md)
...
- [Architecture decision record starter](architecture/decisions/0001-record-architecture-decisions.md)

## Engineering

- [Runbook](engineering/runbook.md)
- [Verification](engineering/verification.md)
...
- [Prompt recipes](agent/prompt-recipes.md)
- [Failure patterns](agent/failure-patterns.md)

## Features

- [F001 example feature](features/F001-example-feature.md)
