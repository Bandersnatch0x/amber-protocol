...
describe("notifier", () => {
  ...
  it("should format session_failed message", () => {
    const message = formatNotification("session_failed", { sessionId: "456", error: "test error" });
  ...
  it("should format budget_warning message", () => {
    const message = formatNotification("budget_warning", { sessionId: "789", percentage: 90, used: 9000, total: 10000 });
