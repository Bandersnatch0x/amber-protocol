...
describe("scanForSecrets", () => {
	...
	it("detects tokens and passwords in common patterns", () => {
		const cases = [
			{ file: "/tmp/token.js", content: 'const token = "ghp_1234567890abcdef1234567890abcdef1234";', type: "GitHub Token" },
			{ file: "/tmp/password.js", content: 'const password = "superSecret123!";', type: "Password Assignment" },
			{ file: "/tmp/jwt.js", content: 'const jwt = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c";', type: "JWT Token" },
		];
	...
	it("does not flag false positives in comments about secrets", () => {
		...
		assert.strictEqual(results.filter(r => r.type !== "Password Assignment").length, 0,
