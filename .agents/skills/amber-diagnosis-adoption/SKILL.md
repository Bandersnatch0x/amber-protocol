...
name: amber-diagnosis-adoption
description: Diagnose Amber readiness and adopt or repair governance without silently changing user files.
x-amber-json: {"kind":"journey","command":"node scripts/amber.js audit --target {{target}}","commandName":"diagnosis-adoption","args":[{"name":"target","hint":"repo path","default":"."}],"manualName":"amber-diagnosis-adoption"}
---
